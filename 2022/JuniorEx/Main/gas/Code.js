...
function doPost(e) {
  if((e.parameter.Passcode == passcode)||(e.parameter.Passcode == masterkey)){
    ...
    sheet.appendRow([new Date(),e.parameter.TeamID,e.parameter.Round,e.parameter.Point,e.parameter.Time,
                    e.parameter.Mission1_1,e.parameter.Mission1_2,
                    e.parameter.Mission2_1,e.parameter.Mission2_2,
                    e.parameter.Mission3_1,e.parameter.Mission4_1,
                    e.parameter.Mission5_1,
                    e.parameter.Mission6_1,e.parameter.Mission6_2,e.parameter.Mission6_3,e.parameter.exhibition]);
