...
//点数計算用の配列定義
var Score_array = new Array(11).fill(0);

var caution_flag = new Array(0,0).fill(0);
var obj_mission1 = new Array(0,0,0).fill(0);
var obj_mission2 = new Array(0,0,0).fill(0);
...
function Scoring(mission,selected){
    ...
    switch(mission){
        case 1:
            ...
            obj_mission1[0] = Number(obj_mission1[1]) + Number(obj_mission1[2]);
            if(Number(obj_mission1[0])<=2){
                caution_flag[0] = 0;
            }
            else{
                caution_flag[0] = 1;
        ...
        case 3:
            ...
            obj_mission2[0] = Number(obj_mission2[1]) + Number(obj_mission2[2]);
            if(Number(obj_mission2[0])<=1){
                caution_flag[0] = 0;
            }
            else{
                caution_flag[0] = 1;
        ...
        case 10:
            each_point = -12;
            document.getElementById("check_M6-3").innerText = selected;
            document.getElementById("check_M6-3_Total").innerText = selected*each_point;
            break;
        default:
            console.log("ERROR!!");
            break;
